...
2. To deploy this cloudformation template to AWS, follow below given steps, use the params.json file to input <b>your</b> GitHubRepo, GitHubBranch, GitHubToken, GitHubUser, MlOpsStepFunctionArn. Instructions to get value for MlOpsStepFunctionArn, can be found our [here](https://github.com/aws-samples/sam-sf-sagemaker-workflow).
```
